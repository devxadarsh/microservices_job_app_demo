...
import com.devx.whatsappclone.common.StringResponse;
...
public class ChatController {
    ...
    @PostMapping
    public ResponseEntity<StringResponse> createChat(@RequestParam(name = "sender-id") String senderId, @RequestParam(name = "recipient-id") String recipientId) {
