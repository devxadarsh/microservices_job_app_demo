...
import { findMessagesByChatId } from '../fn/message/find-messages-by-chat-id';
import { FindMessagesByChatId$Params } from '../fn/message/find-messages-by-chat-id';
...
export class MessageService extends BaseService {
  ...
  /** Path part for operation `findMessagesByChatId()` */
  static readonly FindMessagesByChatIdPath = '/api/v1/messages/chat/{chatId}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findMessagesByChatId()` instead.
   *
   * This method doesn't expect any request body.
   */
  findMessagesByChatId$Response(params: FindMessagesByChatId$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<MessageResponse>>> {
    return findMessagesByChatId(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findMessagesByChatId$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findMessagesByChatId(params: FindMessagesByChatId$Params, context?: HttpContext): Observable<Array<MessageResponse>> {
    return this.findMessagesByChatId$Response(params, context).pipe(
